...
export default function Archive() {
  ...
  useEffect(() => {
    ...
    if (isBypass) {
      // Demo mode: use mock recordings
      const now = Date.now();
      const demoRecs: Recording[] = [
        { id: "demo-rec-1", title: "Morning Announcements - Dec 13", status: "ready", createdAt: new Date(now - 2 * 3600_000).toISOString(), duration: 754, usageType: "live+recording", roomName: "Announcements Studio", thumbnailUrl: "", videoUrl: "" },
        { id: "demo-rec-2", title: "Band Practice Session", status: "ready", createdAt: new Date(now - 26 * 3600_000).toISOString(), duration: 2712, usageType: "recording_only", roomName: "Music Room", thumbnailUrl: "", videoUrl: "" },
        { id: "demo-rec-3", title: "Principal Address", status: "ready", createdAt: new Date(now - 3 * 86400_000).toISOString(), duration: 525, usageType: "live", roomName: "Main Stage", thumbnailUrl: "", videoUrl: "" },
        { id: "demo-rec-4", title: "Fall Play - Act 1", status: "processing", createdAt: new Date(now - 5 * 86400_000).toISOString(), duration: 5025, usageType: "live+recording", roomName: "Auditorium", thumbnailUrl: "", videoUrl: "" },
      ];
      setItems(demoRecs);
      setLoading(false);
